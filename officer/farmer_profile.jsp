				 ...
				 <div class="col-md-12">
				   <div class="card">
					 ...
					 <div class="card-header">
									...
									<% if(pg.equals("sa")) { %> <a class="btn btn-primary" href="sca_view.jsp"><i class="bi bi-arrow-left"></i>Back</a><% } else if(pg.equals("qa")) { %> <a class="btn btn-primary" href="query_view.jsp"><i class="bi bi-arrow-left"></i>Back</a><% } %>
