  ...
  <thead>
    <tr>
      ...
      <th width="111"><div align="center"><strong>Status</strong></div></th>
	   <th width="111"><div align="center"><strong>Action</strong></div></th>
    </tr>
...
%>
  <tr>
    ...
    <td><div align="center"><% if(sts.equals("accepted")) { %><label class="badge badge-success">Accepted</label><% } else if(sts.equals("rejected")) { %><label class="badge badge-danger">Rejected</label><% } else { %><label class="badge badge-primary">Requested</label><% }%> </div></td>
	    <td><div align="center"><% if(sts.equals("requested")) { %><a onClick="return confirm('Are you sure?')" href="sca_prms.jsp?id=<%=i%>&pr=acpt" title="Confirm" class="btn btn-success btn-sm"><i class="fa fa-check"></i> Accept</a> <a onClick="return confirm('Are you sure?')" href="sca_prms.jsp?id=<%=i%>&pr=rjct" title="Reject" class="btn btn-danger btn-sm"><i class="fa fa-close"></i> Reject</a><% } else { out.println("-"); } %></div></td>
