...
%>
  <tr>
    ...
    <td><div align="center"><a href="../uploads/<%=fl%>" title="View / Download"><img src="../wfs_tmp/images/pdf_files.ico" width="80px" height="80px"/></a></div></td>
    <td><div align="center"><label class="badge badge-success"><%=rs.getString("sc_status")%></label></div></td>
 <!--<td><a href="scheme_edit.jsp?id=<%=i%>" title="Edit" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a> <a onClick="return confirm('do you want to delete your data....?')" href="scheme_delete.jsp?id=<%=i%>" title="Delete" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a></td> -->
  </tr>
  <% 
  }
  %>
