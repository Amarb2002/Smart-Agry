                        ...
                        <div class="header-wrap">
                           <form class="form-header" action="#" method="POST">
                            ...
                            <div class="header-button">
								...
								ResultSet rs=s.stm.executeQuery("select * from officer_details where o_email='"+un+"'");
								rs.next();
								String pht=rs.getString("o_photo");
								String nm=rs.getString("o_fname")+" "+rs.getString("o_lname");
							%>
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <span class="email">Officer Panel</span>
                                                </div>
                                            </div>
