            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
						...
						<li>
                            <a href="myprofile.jsp"><i class="fas fa-user"></i>My Profile</a>
                        </li>
						
						<li>
                            <a href="landview.jsp"><i class="fas fa-map"></i>Land Details</a>
                        </li>
						
						<li>
                            <a href="officer_view.jsp"><i class="fas fa-users"></i>Officer Details</a>
                        </li>
						...
						<li>
                            <a href="query_view.jsp"><i class="fas fa-question"></i>Queries</a>
                        </li>
