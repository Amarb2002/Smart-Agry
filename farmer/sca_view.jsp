...
<table width="896" class="table">
  <thead>
    <tr>
      ...
      <th width="134"><div align="center"><strong>Action</strong></div></th>
    </tr>
  ...
  <%
	...
	ResultSet rs=s.stm.executeQuery("select * from scheme_applied sa,schems s,farmer_details f where sa.f_id=f.f_id and sa.sc_id=s.sc_id and f.f_mobile='"+un+"'");
	while(rs.next())
	{
...
%>
 ...
 <td><div align="center"><% if(sts.equals("requested")) { %><a onClick="return confirm('Are you sure?')" href="sca_delete.jsp?id=<%=i%>" title="Delete" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a><% } else { out.println("-"); } %></div></td>
  </tr>
  <% 
  }
  %>
