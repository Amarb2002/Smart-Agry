...
%>
  <tr>
	...
	<% ResultSet rs1=ss.stm.executeQuery("select * from schems s,scheme_applied sa,farmer_details f where s.sc_id=sa.sc_id and sa.f_id=f.f_id and f.f_mobile='"+un+"'"); if(!rs1.next()) { %>
    <td><div align="center"><a href="sca_form.jsp?id=<%=i%>" class="btn btn-primary btn-sm">Apply for Scheme</a></div></td>
  	<% } else { %><td><div align="center">-</div></td><% }%>
  </tr>
  <% 
  }
  %>
